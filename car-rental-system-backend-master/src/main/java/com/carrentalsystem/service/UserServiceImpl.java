...
public class UserServiceImpl implements UserService {
	...
	@Override
	public List<User> getUserByEmailAndStatus(String emailId, String status) {
	...
	@Override
	public List<User> getUserByEmailIdAndRoleAndStatus(String emailId, String role, String status) {
